...
[Отчет](https://github.com/alice480/s21_Linux/blob/main/src/linux1.md) находится в папке src 
...
##### Разрешить созданному пользователю выполнять команду sudo.
...
CRON - ппрограмма, которая упрощает периодический вызов других программ.
